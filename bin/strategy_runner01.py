...
class TendencyIndicator(bt.ind.PeriodN):
    ...
    plotlines = dict(zigzag=dict(_name='zigzag', color='red', ls='--', _skipnan=True),
                     zigzag2=dict(_name='zigzag2', color='green', ls='--', _skipnan=True),)
    params = (('period', 2),)
...
if __name__ == '__main__':  # Точка входа при запуске этого скрипта
    ...
    cerebro.plot(style='bar', bardown='grey')  # Рисуем график. Требуется matplotlib версии 3.2.2 (pip install matplotlib==3.2.2)
